...
1.  [**Global Database of Events, Language and Tone (GDELT)**]{.underline}
...
| Initially, we could only collect 100 artworks of data from Smithsonian API. | Further research and using different endpoints |
